...
<ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
    ...
    @role('student') 
        <li class="nav-item">
            <a class="nav-link" href="{{ route("attendance.index") }}">
                ...
                <span>{{ __("Mark Tody's Attendance") }}</span></a>
        </li>

        <li class="nav-item">
            <a class="nav-link" href="{{ route("attendance.view") }}">
                <i class="fas fa-fw fa-clock"></i>
                <span>{{ __("View Attendance") }}</span></a>
        </li>
    @endrole 
    ...
    @role('Super-Admin') 
        <li class="nav-item">
            <a class="nav-link" href="{{ route("admin.attendances.index") }}">
                <i class="fas fa-fw fa-clock"></i>
                <span>{{ __("Manage Attendance") }}</span></a>
        </li> 
    @endrole 
    ...
    <li class="nav-item">
        ...
        <div id="Testimonials" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="{{ route('testimonials.index') }}">{{ __('Testimonials') }}</a>
                <a class="collapse-item" href="{{ route('role.index') }}">{{ __('Testimonials Create') }}</a>
